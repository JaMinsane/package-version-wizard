		...
		<div class="grid gap-8 xl:grid-cols-[1.08fr_0.92fr] xl:items-start">
			<div class="max-w-3xl">
				<div class="flex flex-wrap items-center gap-3">
					...
					<span class="neon-badge neon-badge--muted"> SvelteKit + n8n </span>
				</div>
			...
			<div class="grid gap-4">
				{#each homeHeroStats as stat}
					<article class="data-cell">
						<p
							class="text-sm font-bold tracking-widest text-[var(--neon-green)] uppercase"
							style="text-shadow: 0 0 8px rgba(15,255,106,0.3)"
						>
							{stat.value}
						</p>
